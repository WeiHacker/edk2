/** @file
  Homework 1.3 second PEIM for PEI dispatch order verification.
...
/**
  Entry point for the second homework PEIM.
...
EFI_STATUS
EFIAPI
Homework13PeimSecondEntryPoint (
  ...
  )
{
  ...
  DEBUG ((DEBUG_INFO, "Homework13PeimOrder: 2 - Homework13PeimSecond executed\n"));
  return EFI_SUCCESS;
}
