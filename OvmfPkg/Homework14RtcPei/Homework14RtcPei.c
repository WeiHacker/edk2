/** @file
  Homework 1.4 RTC read PEIM.

  This PEIM reads the CMOS RTC through I/O ports 0x70/0x71 and prints the
  current date and time during PEI.
...
/**
  Entry point for the RTC read PEIM.
